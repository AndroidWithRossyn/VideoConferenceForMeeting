...
import com.videomeetings.conference.model.InterfaceAudioJava;
...
public class CallingAudioActivity extends BaseActivity {
    String uniqueId = "";
    String username = "";
...
//    Group controls;
    ...
    protected int getLayoutId() {
        return R.layout.activity_calling_audio;
    }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        volumeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                isSpeaker = !isSpeaker;
                if (isSpeaker) {
                    volumeBtn.setImageResource(R.drawable.btn_video_normal);
//                    audioManager.setSpeakerphoneOn(true);
//                    audioManager.setStreamMute(AudioManager.STREAM_SYSTEM, true);
                    UnMuteAudio();
                } else {
                    volumeBtn.setImageResource(R.drawable.btn_video_muted);
                    MuteAudio();
...
//                    audioManager.setSpeakerphoneOn(false);
    ...
    void setupWebView() {
        ...
        webView.addJavascriptInterface(new InterfaceAudioJava(this), "Android");
