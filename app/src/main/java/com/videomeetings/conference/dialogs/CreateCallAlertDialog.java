...
public class CreateCallAlertDialog extends DialogFragment {
    AlertDialog alertDialog;
    EditText editText;
    OnClickListener onClickListener;

    public CreateCallAlertDialog(OnClickListener listener) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_create_call, null);
    ...
    @OnClick({R.id.mTxtShare, R.id.mTxtJoin, R.id.mIVClose})
    ...
    void mGetShareString() {
        if (isEmptyStr(editText.getText().toString())) {
            Toast.makeText(getContext(), "Enter Code..!", Toast.LENGTH_SHORT).show();
        } else {
            onClickListener.OnShare(editText.getText().toString());
            alertDialog.dismiss();
        }
    }
